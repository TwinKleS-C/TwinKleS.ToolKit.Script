...
namespace TwinKleS.Support.PopCapAnimation.Convert.Compute {
	...
	function compute_sprite_slot(
		raw_frame: Array<Core.Tool.Animation.PopCapAnimation.Information.JS_N.Frame>,
		sub_sprite: Array<[SpriteSlot, LayerImageMap]>,
		image: Array<Core.Tool.Animation.PopCapAnimation.Information.JS_N.Image>,
	...
	function compute_sprite_frame_label(
		frame: Array<Core.Tool.Animation.PopCapAnimation.Information.JS_N.Frame>,
	...
	export function compute(
		animation: Core.Tool.Animation.PopCapAnimation.Information.JS_N.Animation,
