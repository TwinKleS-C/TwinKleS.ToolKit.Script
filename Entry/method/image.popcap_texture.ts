/**
 * + image.popcap_texture.encode PopCap-Texture 编码
 * + image.popcap_texture.decode PopCap-Texture 解码
 */
namespace TwinKleS.Entry.method.image.popcap_texture {
	...
	export function _injector(
		...
		g_executor_method.push(
			Executor.method_of({
				id: 'image.popcap_texture.encode',
				description: 'PopCap-Texture 编码',
				worker(a: Entry.CFSA & {
					image_file: string;
			...
			Executor.method_of({
				id: 'image.popcap_texture.decode',
				description: 'PopCap-Texture 解码',
				worker(a: Entry.CFSA & {
					data_file: string;
...
({
	injector: TwinKleS.Entry.method.image.popcap_texture._injector,
});