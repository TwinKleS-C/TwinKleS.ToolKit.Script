/**
 * + other.pvz2.lawn_string_text.convert PvZ2字符串表 版本转换
 */
namespace TwinKleS.Entry.method.other.pvz2.lawn_string_text {
	...
	export function _injector(
		...
		g_executor_method.push(
			Executor.method_of({
				id: 'other.pvz2.lawn_string_text.convert',
				description: 'PvZ2字符串表 版本转换',
				worker(a: Entry.CFSA & {
					source_file: string;
...
({
	injector: TwinKleS.Entry.method.other.pvz2.lawn_string_text._injector,
});