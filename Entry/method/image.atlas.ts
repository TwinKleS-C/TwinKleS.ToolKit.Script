		...
		g_executor_method.push(
			Executor.method_of({
				...
				worker(a: Entry.CFSA & {
					...
					Support.Atlas.pack_fs(manifest_file, atlas_file, sprite_directory);
			...
			Executor.method_of({
				...
				worker(a: Entry.CFSA & {
					...
					Support.Atlas.unpack_fs(manifest_file, atlas_file, sprite_directory);
			...
			Executor.method_of({
				...
				worker(a: Entry.CFSA & {
					...
					Support.Atlas.pack_auto_fs(manifest_file, atlas_file, sprite_directory);
					Output.i(`输出路径：${atlas_file}`);
				},
				default_argument: {
					...Entry.k_cfsa,
