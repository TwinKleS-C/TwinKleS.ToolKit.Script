/**
 * + other.popcap_rton.encode PopCap-RTON 编码
 * + other.popcap_rton.decode PopCap-RTON 解码
 * + other.popcap_rton.encrypt PopCap-RTON 加密
 * + other.popcap_rton.decrypt PopCap-RTON 解密
 * + other.popcap_rton.encode_then_encrypt PopCap-RTON 编码并加密
 * + other.popcap_rton.decrypt_then_decode PopCap-RTON 解密并解码
 * + other.popcap_rton.encode.batch [批处理] PopCap-RTON 编码
 * + other.popcap_rton.decode.batch [批处理] PopCap-RTON 解码
 * + other.popcap_rton.encrypt.batch [批处理] PopCap-RTON 加密
 * + other.popcap_rton.decrypt.batch [批处理] PopCap-RTON 解密
 * + other.popcap_rton.encode_then_encrypt.batch [批处理] PopCap-RTON 编码并加密
 * + other.popcap_rton.decrypt_then_decode.batch [批处理] PopCap-RTON 解密并解码
 */
namespace TwinKleS.Entry.method.other.popcap_rton {
	...
	export function _injector(
		...
		g_executor_method.push(
			Executor.method_of({
				...
				worker(a: Entry.CFSA & {
					...
					CoreX.Tool.Other.PopCapRTON.encode_fs(json_file, rton_file, true, true, true, rton_data_buffer_size);
			...
			Executor.method_of({
				...
				worker(a: Entry.CFSA & {
					...
					CoreX.Tool.Other.PopCapRTON.decode_fs(rton_file, json_file, true);
			...
			Executor.method_of({
				...
				worker(a: Entry.CFSA & {
					...
					CoreX.Tool.Other.PopCapRTON.encrypt_fs(plain_file, cipher_file, key);
			...
			Executor.method_of({
				...
				worker(a: Entry.CFSA & {
					...
					CoreX.Tool.Other.PopCapRTON.decrypt_fs(cipher_file, plain_file, key);
			...
			Executor.method_of({
				id: 'other.popcap_rton.encode_then_encrypt',
				...
				worker(a: Entry.CFSA & {
					...
					CoreX.Tool.Other.PopCapRTON.encode_then_encrypt_fs(json_file, rton_file, true, true, true, key, rton_data_buffer_size);
					Output.i(`输出路径：${rton_file}`);
				},
				default_argument: {
					...Entry.k_cfsa,
			...
			Executor.method_of({
				id: 'other.popcap_rton.decrypt_then_decode',
				...
				worker(a: Entry.CFSA & {
					...
					CoreX.Tool.Other.PopCapRTON.decrypt_then_decode_fs(rton_file, json_file, true, key);
					Output.i(`输出路径：${json_file}`);
				},
				default_argument: {
					...Entry.k_cfsa,
		...
		g_executor_method_of_batch.push(
			Executor.method_of({
				id: 'other.popcap_rton.encode.batch',
				...
				worker(a: Entry.CFSA & {
					...
					simple_batch_execute(
						...
						(item) => {
							...
							CoreX.Tool.Other.PopCapRTON.encode_fs(json_file, rton_file, true, true, true, rton_data_buffer.view());
						},
					);
			...
			Executor.method_of({
				id: 'other.popcap_rton.decode.batch',
			...
			Executor.method_of({
				id: 'other.popcap_rton.encrypt.batch',
			...
			Executor.method_of({
				id: 'other.popcap_rton.decrypt.batch',
			...
			Executor.method_of({
				id: 'other.popcap_rton.encode_then_encrypt.batch',
				...
				worker(a: Entry.CFSA & {
					...
					simple_batch_execute(
						...
						(item) => {
							let json_file = `${json_file_directory}/${item}`;
							let rton_file = `${rton_file_directory}/${item.slice(0, -5)}.rton`;
							CoreX.Tool.Other.PopCapRTON.encode_then_encrypt_fs(json_file, rton_file, true, true, true, key, rton_data_buffer.view());
						},
					);
					Output.i(`输出路径：${rton_file_directory}`);
				},
			...
			Executor.method_of({
				id: 'other.popcap_rton.decrypt_then_decode.batch',
...
({
	injector: TwinKleS.Entry.method.other.popcap_rton._injector,
});